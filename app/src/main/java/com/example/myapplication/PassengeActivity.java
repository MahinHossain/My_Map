...
public class PassengeActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_passenge);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (Build.VERSION.SDK_INT < 24) {
            ...
            if (ContextCompat.checkSelfPermission(PassengeActivity.this,
                    Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(PassengeActivity.this, new String[]
